        ...
        {/* {
                    notes.length <= 0 && (
                        <div className='my-10'>
                            ...
                            <div className='text-center'>
                                <h1 className='text-2xl md:text-3xl font-semibold tracking-wider'>No saved notebooks yet</h1>
                                <p className='text-sm md:text-base text-slate-200 mb-5'>Your saved notebooks will apear here and you can access anytime.</p>
                                <Link to='/add-note'>
                                    <button className="inline-flex items-center gap-5 px-5 py-3 group rounded-xl bg-gradient-to-tr from-[#1e2d4056] to-[#0fcda122] border border-gray-500 hover:border-[#0fcda1] focus:border focus:border-[#0fcda1] text-white">
                                        ...
                                        <span className="flex flex-col gap-1 items-start">
                                            <span className="text-xs text-slate-300">Write your notes</span>
                                            <span className="font-semibold title-font">Save on NoteBook</span>
                                        </span>
                                    </button>
                                </Link>
                            </div>
