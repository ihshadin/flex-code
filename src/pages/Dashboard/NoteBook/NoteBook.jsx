        ...
        <section>
            <div className='flexcode-container'>
                <div className='border-b-2 border-[#0fcda185] pb-3 flex justify-between items-center'>
                    <div>
                        <h1 className='text-white text-2xl md:text-4xl tracking-wider font-semibold'>My NoteBooks</h1>
                ...
                <div className='grid lg:grid-cols-3 gap-5 mt-12'>
                    {notes?.map(note => (
                        <div key={note._id} className="flex flex-col border gap-2 p-5 rounded-xl border-gray-500 hover:border-[#0fcda1] transition-all bg-[#1e2d40] h-52">
