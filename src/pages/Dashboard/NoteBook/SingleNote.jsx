        ...
        <section>
            <div className="flexcode-container">
                <div className='border-b-2 border-[#0fcda185] pb-3 flex justify-between items-center'>
                    <div>
                        <h1 className='text-white text-xl md:text-3xl tracking-wider font-semibold'>{note.title}</h1>
                ...
                <div className="flex gap-5 mt-16">
                    ...
                    <div className="lg:w-[70%] bg-secondary-color py-10 md:px-5 lg:px-10 rounded-xl">
                        <h1 className="text-2xl font-semibold leading-tight primary-color">
                            {note?.title}
                        </h1>
                    ...
                    <div className="lg:w-[30%] flex flex-col bg-secondary-color py-5 md:px-5 rounded-xl divide-y-2 divide-[#0fcda156]">
