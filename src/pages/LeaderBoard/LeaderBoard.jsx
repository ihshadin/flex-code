...
const LeaderBoard = () => {
  ...
  useEffect(() => {
    axiosNormal.get("/solvedProblems/leaderboard").then((data) => {
  ...
  return (
        ...
        <div className="border-b-2 border-[#0fcda185] pb-3 flex justify-between items-center">
          <div>
            ...
            <p className="text-slate-300 text-sm md:text-base mt-1">
              Meet the Brilliant Minds Behind the Solutions
            </p>
          </div>
          <Link to="/dashboard">
	...
	C68.1,265.8,74.4,272.4,74.3,280.5z"
        ...
        <div className="grid md:grid-cols-3 items-center justify-center gap-8 my-12">
          {solvedProblems[1] && (
            <Top3Card data={solvedProblems[1]} position={2} />
          )}
          {solvedProblems[0] && (
            <Top3Card data={solvedProblems[0]} position={1} />
          )}
          {solvedProblems[2] && (
            <Top3Card data={solvedProblems[2]} position={3} />
          )}
        </div>
                ...
                {solvedProblems.slice(3).map((solveProblem, index) => (
                  ...
                  >
                    ...
                    <p className="w-[40%] flex gap-2">
                      ...
                      />
                      <div>
                        <h2 className="font-medium">{solveProblem.userName}</h2>
                        <p className="text-sm text-slate-400">
                          @
                          {solveProblem.userName
                            .toLowerCase()
