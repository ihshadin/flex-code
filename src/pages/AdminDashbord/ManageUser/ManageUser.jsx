...
const ManageUser = () => {
  ...
  useEffect(() => {
    axios
      .get("https://flex-code-server-ihshadin.vercel.app/users/all")
  ...
  const handleMakeAdmin = async (email) => {
    try {
      const res = await axios.post(
        `https://flex-code-server-ihshadin.vercel.app/users/all/admin/${email}`
      );
  ...
  const handleMakeUser = async (email) => {
    try {
      const res = await axios.post(
        `https://flex-code-server-ihshadin.vercel.app/users/all/genarel/${email}`
      );
