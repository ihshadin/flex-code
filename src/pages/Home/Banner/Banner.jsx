...
const Banner = () => {
  return (
    <div className="relative">
      ...
      <div className="flexcode-container w-full md:h-[650px] pt-16 flex flex-col-reverse md:flex-row items-center justify-center overflow-hidden">
        ...
        <div className="relative pt-20 pb-10 md:py-40 px-3 w-full md:w-1/2 h-full sm:h-1/2 md:h-full flex flex-col justify-center items-center md:items-start text-center md:text-left text-white">
          ...
          <h2 className="banner-title text-3xl md:text-6xl font-semibold ">
            Feel like{" "}
            <span className="text-[#08ecb8] font-semibold">coding</span> in your
            own environment
          </h2>
          <div className="mt-10">
            <Link>
        ...
        <div className="hidden sm:block relative w-full md:w-[35%]">
          <img
            src={banner}
            alt=""
