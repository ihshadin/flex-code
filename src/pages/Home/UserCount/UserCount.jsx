    ...
    <>
      <section>
        <div className="flexcode-container">
          <div className="rounded-xl py-16 text-center border-[#00ffc356] border-2 drop-shadow-lg grid gap-10 lg:gap-0 lg:grid-cols-3 justify-center text-white  montserrat divide-x-2 divide-[#00ffc356]">
