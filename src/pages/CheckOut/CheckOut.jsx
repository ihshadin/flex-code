...
const CheckOut = () => {
  ...
  return (
    <div className="flex items-center gap-x-6 flexcode-container">
      <div className="bg-secondary-color p-10 rounded-md w-[60%]">
        ...
        <p className="text-xl">
          ...
          previously sold for{" "}
          <span className="text-[#00ffc3] font-semibold">$299 </span> and is now
          only <span className="text-[#00ffc3] font-semibold">$13.25 </span>
      ...
      <div class="bg-secondary-color p-10 rounded-lg w-[40%] text-white">
