        ...
        <section>
            <div className="flexcode-container">
                <div className='border-b-2 border-[#0fcda185] pb-3 flex justify-between items-center'>
                    <div>
                        <h1 className='text-white text-xl md:text-3xl tracking-wider font-semibold'>{explore.title}</h1>
                        <p className='text-slate-300 text-sm md:text-base mt-1'>This type of exploration involves delving into new subjects</p>
                    </div>
                    <Link to='/explore'>
                        <button className="inline-flex items-center gap-5 px-5 py-3 group rounded-xl bg-gradient-to-tr from-[#1e2d4056] to-[#0fcda122] border border-gray-500 hover:border-[#0fcda1] focus:border focus:border-[#0fcda1] text-white">
                            ...
                            <img className='w-10' src={backButton} alt="" />
                            <span className="flex flex-col gap-1 items-start">
                                <span className="text-xs text-slate-300">Explore Details</span>
                                <span className="font-semibold title-font">View All Explore</span>
                            </span>
                        </button>
                    </Link>
                </div>
