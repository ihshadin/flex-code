                 ...
                 <div className="flex -mx-3">
                     <div className="w-full px-3 mb-5">
                         ...
                         <div className="flex">
                             ...
                             <input defaultValue={user?.displayName}  readOnly type="text" className="w-full -ml-10 pl-10 pr-3 bg-[#1e2d40] py-2 rounded-lg border-2 border-gray-500 outline-none focus:border-[#00ffc3]" placeholder="John" {...register("user_name")}/>
                         </div>
                     </div>
                 ...
                 <div className="flex -mx-3">
                     <div className="w-full px-3 mb-5">
                         ...
                         <div className="flex">
                             ...
                             <input onKeyUp={(e) => setExp(e.target.value)} type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-500 bg-[#1e2d40] outline-none focus:border-[#00ffc3]" placeholder="Awesome experience" {...register("main_expression", { required: true }) }/>
                         </div>
                     </div>
                 </div>
                 <div className="flex -mx-3">
...
/>
                 ...
                 <div className="flex -mx-3">
                     <div className="w-full px-3 mb-5">
                         <button type="submit" className="block w-full max-w-xs mx-auto bg-[#1da888] hover:bg-[#2bd1aa] focus:bg-[#27c9a3] text-white rounded-lg px-3 py-3 font-semibold">DONE</button>
                     </div>
                 </div>
             </form>
